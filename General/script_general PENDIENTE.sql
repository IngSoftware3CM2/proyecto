...
DROP TABLE IF EXISTS public.horariocubierto CASCADE;
...
CREATE TABLE public.personal (
	...
	/*CONSTRAINT personalhorariocubierto_fk FOREIGN KEY(idHorarioCubierto)
		REFERENCES public.horariocubierto (idHorarioCubierto)
		ON UPDATE CASCADE
		ON DELETE set null*/
);
